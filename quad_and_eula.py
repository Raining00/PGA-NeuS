...
q = [-0.40075622,  0.90143122, -0.137869,    0.08836486]
...
delat_P = [-90, 180, 0]
roll = math.radians(115 + delat_P[0])  # Roll: rotation around the x-axis
pitch = math.radians(-52+ delat_P[1])  # Pitch: rotation around the y-axis
yaw = math.radians(58.55+ delat_P[2])  # Yaw: rotation around the z-axis
